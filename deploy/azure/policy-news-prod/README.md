...
이 디렉터리는 `rg_aipol`의 Azure Container Apps Job을 정의합니다. 작업은 매일 오전 6시(한국시간)에 최대 3개의 해외 공식기관 자료를 수집하고, Solar Open2로 한국어 검토 초안을 만든 뒤 Naia AnyLLM 전용 계정의 Grok 4.3으로 원문을 대조합니다.
...
- 작업이 꺼져 있으면 공급자 비밀과 Blob 쓰기 권한을 연결하지 않습니다.
